...
class Config:
    ...
    MONGO_DB_URI = os.environ.get("MONGO_DB_URI", "mongodb+srv://Testbot:Testbot@cluster0.5iukc4c.mongodb.net/?appName=Cluster0")
    ...
    URL = os.environ.get("URL", "https://aparsonalfile.onrender.com").rstrip('/')
